...
func _process_horizontal_rotation_input() :
	if follow_target == FOLLOW_TARGETS.PARENT :
		return
	if InputMap.has_action("pan_right") and InputMap.has_action("pan_left") :
		var camera_horizontal_rotation_variation = Input.get_action_strength("pan_right") -  Input.get_action_strength("pan_left")
...
func _process_tilt_input() :
	if InputMap.has_action("pan_up") and InputMap.has_action("pan_down") :
		var tilt_variation = Input.get_action_strength("pan_up") -  Input.get_action_strength("pan_down")
